...
const whiteGlow = "0 0 10px #fff, 0 0 15px #fff, 0 0 15px rgb(255, 255, 255), 0 0 15px rgb(255, 255, 255), 0 0 15px rgb(255, 255, 255), 0 0 15px rgb(255, 255, 255), 0 0 15px rgb(255, 255, 255)";
    ...
    return (
        <div className="pointer-events-none z-0 blur w-screen h-screen absolute overflow-hidden top-0 left-0">
            ...
            <text style={{fill: "rgb(255, 255, 255)", fontFamily: "Arial, sans-serif", fontSize: "28px", whiteSpace: "pre"}}>
                <motion.textPath initial={{ startOffset: "-100%"}} animate={{ startOffset: "100%"}} transition={{duration: wormDuration, delay: 0, ease: "linear", repeatType: "reverse", repeat: Infinity}} href="#path-0">==============================================</motion.textPath>
            </text>
            </svg>
            ...
            <text style={{fill: "rgb(255, 255, 255)", fontFamily: "Arial, sans-serif", fontSize: "28px", whiteSpace: "pre"}}>
                <motion.textPath initial={{ startOffset: "-100%"}} animate={{ startOffset: "100%"}} transition={{duration: wormDuration, delay: 1, ease: "linear", repeatType: "reverse", repeat: Infinity}} href="#path-0">==================================================</motion.textPath>
            </text>
            </svg>
            ...
            <text style={{fill: "rgb(255, 255, 255)", fontFamily: "Arial, sans-serif", fontSize: "28px", whiteSpace: "pre"}}>
                <motion.textPath initial={{ startOffset: "-100%"}} animate={{ startOffset: "100%"}} transition={{duration: wormDuration, delay: 5, ease: "linear", repeatType: "reverse", repeat: Infinity}} href="#path-0">=======================================</motion.textPath>
            </text>
            </svg>
            ...
            <text style={{fill: "rgb(255, 255, 255)", fontFamily: "Arial, sans-serif", fontSize: "28px", whiteSpace: "pre"}}>
                <motion.textPath initial={{ startOffset: "-100%"}} animate={{ startOffset: "100%"}} transition={{duration: wormDuration, delay: 6, ease: "linear", repeatType: "reverse", repeat: Infinity}} href="#path-0">===========================================================</motion.textPath>
            </text>
            </svg>
            ...
            <motion.text style={{fill: "rgb(255, 255, 255)", fontFamily: "Arial, sans-serif", fontSize: "28px", whiteSpace: "pre", textShadow: "unset" }}>
                <motion.textPath initial={{ startOffset: "-100%"}} animate={{ startOffset: "100%"}} transition={{duration: wormDuration, delay: 4, ease: "linear", repeatType: "reverse", repeat: Infinity}} href="#path-0">=============================================</motion.textPath>
            </motion.text>
            </svg>
